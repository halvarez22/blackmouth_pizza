    ...
    >
      <div className="container mx-auto px-6 py-2 flex justify-between items-center">
        <a href={isSubPage ? '/#' : '#'} aria-label="Blackmouth Pizzeria Home">
          <img src={logoUrl} alt="Blackmouth Pizzeria Logo" className="h-12 md:h-14" />
        </a>
        ...
        <div className="flex items-center">
            <nav className="hidden md:flex items-center space-x-8">
             ...
             {/* Order total display */}
            {totalItems > 0 && (
                <div className="hidden md:flex items-center bg-black border border-orange-600 text-orange-300 rounded-full pl-3 pr-4 py-2 ml-6 animate-fade-in-pop">
